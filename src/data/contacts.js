...
export const conversations = [
  ...
  {
    id: 3, name: 'Jennifer Walsh', company: 'Summit Financial',
    lastMessage: 'CFO approved the deal! Ready for 200-seat Enterprise.',
    time: '3h', channel: 'phone', unread: true, team: 'Sales',
    status: 'online', priority: 'high',
    gradient: contacts[7].gradient,
